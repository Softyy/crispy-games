...
description: ""
sidebar: "catalogue"
prev: "/catalogue/deploying/"
next: "/catalogue/sidebar/"
---
...
Check out the [sidebar](/catalogue/sidebar/) section for more information.

## Next and Previous Navigation

If you scroll to the bottom of the page, you will notice some buttons which link to the previous pages in these catalogue. These are also not automatically generated but configured in the frontmatter of your markdown file like this:

```md
prev: '/catalogue/previous-link/'
next: '/catalogue/next-link/'
```
...
module.exports = {
  settings: {
    nav: {
      links: [{ path: "/catalogue/", title: "catalogue" }],
    },
  },
};
```
